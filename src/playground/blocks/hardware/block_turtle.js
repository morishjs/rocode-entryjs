...
RoCode.Turtle = {
    ...
    getRobot() {
        const robot = RoCode.Robomation.getRobot('turtle', 0);
        if (robot) {
...
RoCode.Turtle.getBlocks = function() {
    return {
        turtle_touching_color: {
            ...
            isNotFor: ['turtle'],
            func(sprite, script) {
                const robot = RoCode.Turtle.getRobot();
