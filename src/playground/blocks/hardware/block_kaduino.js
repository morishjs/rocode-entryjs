...
RoCode.kaduino.blockMenuBlocks = [    /// 하드웨어 블록 등록 , 여기에 등록된 블록이 순서대로 나열되며 설정한 이름으로 화면에 보임
...
RoCode.kaduino.setLanguage = function() {    // 블록 이름  번역
    return {
        ko: {
            template: {
...
RoCode.kaduino.getBlocks = function() {
    return {
            ...
            func: function(sprite, script)
			{
                ...
                if (!script.isStart)
				{
                    ...
                    if (duration == 0) // 음 길이가 0 이면
					{
						...
						{
                            type: RoCode.kaduino.sensorTypes.TONE,
                            data: 0,
        ...
        kaduino_set_digital_buzzer: {
            ...
            func: function(sprite, script) {
                ...
                if (!script.isStart)
				{
					...
					{
                        note = RoCode.kaduino.toneTable[note];
                    }
                    if (note < 0) note = 0;
                    ...
                    if (note != 0) value = RoCode.kaduino.toneMap[note][octave];
                    if(duration > 300)
                        duration = 300;
                    duration = duration * 1000;
                    script.isStart = true;
            ...
            func: function(sprite, script)
			{
                ...
                if(!(lmotor_speed == lspeed) || !(rmotor_speed == rspeed))
                {
                    if (!script.isStart)
                    {
                        ...
                        RoCode.hw.sendQueue['SET'][port] =
                        {
                            type: RoCode.kaduino.sensorTypes.MOTOR,
                            data: [lspeed, rspeed],
                            time: new Date().getTime(),
                        };
                        lmotor_speed = lspeed;
...
//				var mode = 1;
                ...
                RoCode.hw.sendQueue['SET'][port] =
				{
                    type: RoCode.kaduino.sensorTypes.SERVO,
                    data: angle,
                    time: new Date().getTime(),
                };
                return script.callReturn();
                ...
                if(!(rgbled_r[port] == rLED) || !(rgbled_g[port] == gLED) || !(rgbled_b[port] == bLED))
                {
                    if (!script.isStart)
                    {
                        ...
                        RoCode.hw.sendQueue['SET'][port] = {  // port 를
                            type: RoCode.kaduino.sensorTypes.RGBLED,
                            data: {
                                r: rLED,
                                g: gLED,
                                b: bLED,
		...
		kaduino_rgbled_all_onoff:
		{
            ...
            func: function(sprite, script)
			{
                ...
                RoCode.hw.sendQueue['SET'][port] = {
                    type: RoCode.kaduino.sensorTypes.RGBLEDSHOW,
                    data: {
                        mode: ledmode,
                    },
                    time: new Date().getTime(),
		...
		kaduino_digital_onoff: {
           ...
           func: function(sprite, script)
		   {
                ...
                RoCode.hw.sendQueue['SET'][port] = {
                    type: RoCode.kaduino.sensorTypes.DIGITAL,    /// 출력 디바이스
                    data: value,
                    time: new Date().getTime(),
                };
                return script.callReturn();
        ...
        kaduino_get_digital_value: {
            ...
            func: function(sprite, script)
			{
                ...
                RoCode.hw.sendQueue['GET'][
                    RoCode.kaduino.sensorTypes.DIGITAL
                ] = {
                    port: port,
                    time: new Date().getTime(),
                };
		...
		kaduino_set_pwm:
		{
            ...
            func: function(sprite, script)
			{
                ...
                RoCode.hw.sendQueue['SET'][port] =
				{
                    type: RoCode.kaduino.sensorTypes.PWM,
                    data: angle,
                    time: new Date().getTime(),
                };
                return script.callReturn();
        ...
        kaduino_set_ultrasonic:
		{
            ...
            func: function(sprite, script)
			{
                ...
                RoCode.hw.sendQueue['SET'][port] =
				{
                    type: RoCode.kaduino.sensorTypes.USONIC,
                    data: echo,
                    time: new Date().getTime(),
                };
                return script.callReturn();
        ...
        kaduino_get_usonic_value: {
            ...
            isNotFor: ['kaduino'],
            func: function(sprite, script) {
 //               var us = RoCode.hw.portData.USONIC ;
...
/*                if (!RoCode.hw.sendQueue['GET']) {
                ...
                RoCode.hw.sendQueue['GET'][
                    RoCode.kaduino.sensorTypes.USONIC
                ] = {
                    port: [port1, port2],
                    time: new Date().getTime(),
                };*/
...
//                while(time2 + 1000 > new Date().getTime());
        ...
        kaduino_set_temp:
		{
            ...
            func: function(sprite, script)
			{
                ...
                RoCode.hw.sendQueue['SET'][port] =
				{
                    type: RoCode.kaduino.sensorTypes.TEMP,
                    data: sensor,
                    time: new Date().getTime(),
                };
               // return script.callReturn();
        ...
        kaduino_set_i2c:
		{
            ...
            func: function(sprite, script)
			{
                ...
                RoCode.hw.sendQueue['SET'][port] =
				{
                    type: RoCode.kaduino.sensorTypes.I2C_SET,
                    data: sensor,
                    time: new Date().getTime(),
                };
               // return script.callReturn();
                ...
                if (!script.isStart) {
                   ...
                   // var timeValue = 60 / fps * 50;
                    ...
                    RoCode.hw.sendQueue['SET'][3] = {
                        type: RoCode.kaduino.sensorTypes.LCD_SET,
                        data: {
                            line: line,
                            column: column,
                            text0: text[0],
