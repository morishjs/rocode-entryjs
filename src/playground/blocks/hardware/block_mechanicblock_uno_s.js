...
RoCode.MechanicblockUnoS.setLanguage = function() {
    return {
        ko: {
            template: {
...
RoCode.MechanicblockUnoS.blockMenuBlocks = [
...
RoCode.MechanicblockUnoS.getBlocks = function() {
    return {
                        ...
                        textParams: [
                            {
                                ...
                                codeMap: 'RoCode.CodeMap.Arduino.mechanicblock_uno_s_analog_list[0]',
                                bgColor: RoCodeStatic.colorSet.block.darken.HARDWARE,
                                arrowColor: RoCodeStatic.colorSet.arrow.default.HARDWARE,
                            },
                        ],
        ...
        mechanicblock_uno_s_get_ultrasonic_value: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.GET[RoCode.MechanicblockUnoS.sensorTypes.ULTRASONIC] = {
                    port: [port1, port2],
        ...
        mechanicblock_uno_s_get_digital: {
            ...
            func(sprite, script) {
                ...
                if (name === 'MechanicblockUnoS' || name === 'ArduinoNano') {
                    ...
                    RoCode.hw.sendQueue.GET[RoCode.MechanicblockUnoS.sensorTypes.DIGITAL] = {
                        port,
                        time: new Date().getTime(),
                    };
        ...
        mechanicblock_uno_s_toggle_led: {
            ...
            func(sprite, script) {
                ...
                if (RoCode.MechanicblockUnoS.highList.indexOf(value) > -1) {
                    value = 255;
                } else if (RoCode.MechanicblockUnoS.lowList.indexOf(value) > -1) {
                    value = 0;
                } else {
                    throw new Error();
                }
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.MechanicblockUnoS.sensorTypes.DIGITAL,
                    data: value,
                    time: new Date().getTime(),
                };
        ...
        mechanicblock_uno_s_digital_pwm: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.MechanicblockUnoS.sensorTypes.PWM,
                    data: value,
                    time: new Date().getTime(),
                };
                return script.callReturn();
            ...
            func(sprite, script) {
                ...
                if (!script.isStart) {
                    ...
                    if (!RoCode.Utils.isNumber(note)) {
                        note = RoCode.MechanicblockUnoS.toneTable[note];
                    }
                    ...
                    if (duration === 0) {
                        sq.SET[port] = {
                            type: RoCode.MechanicblockUnoS.sensorTypes.TONE,
                            data: 0,
                            time: new Date().getTime(),
                        };
                        return script.callReturn();
                    ...
                    if (note != 0) {
                        value = RoCode.MechanicblockUnoS.toneMap[note][octave];
                    }
        ...
        mechanicblock_uno_s_set_servo: {
            ...
            func(sprite, script) {
                ...
                sq.SET[port] = {
                    type: RoCode.MechanicblockUnoS.sensorTypes.SERVO_PIN,
                    data: value,
                    time: new Date().getTime(),
                };
...
module.exports = RoCode.MechanicblockUnoS;
