...
RoCode.MechanicblockUno.setLanguage = function() {
    return {
        ko: {
            template: {
...
RoCode.MechanicblockUno.blockMenuBlocks = [
...
RoCode.MechanicblockUno.getBlocks = function() {
    return {
                        ...
                        textParams: [
                            {
                                ...
                                codeMap: 'RoCode.CodeMap.Arduino.mechanicblock_uno_analog_list[0]',
                                bgColor: RoCodeStatic.colorSet.block.darken.HARDWARE,
                                arrowColor: RoCodeStatic.colorSet.arrow.default.HARDWARE,
                            },
                        ],
        ...
        mechanicblock_uno_get_ultrasonic_value: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.GET[RoCode.MechanicblockUno.sensorTypes.ULTRASONIC] = {
                    port: [port1, port2],
        ...
        mechanicblock_uno_get_digital: {
            ...
            func(sprite, script) {
                ...
                if (name === 'MechanicblockUno') {
                    ...
                    RoCode.hw.sendQueue.GET[RoCode.MechanicblockUno.sensorTypes.DIGITAL] = {
                        port,
                        time: new Date().getTime(),
                    };
        ...
        mechanicblock_uno_toggle_led: {
            ...
            func(sprite, script) {
                ...
                if (RoCode.MechanicblockUno.highList.indexOf(value) > -1) {
                    value = 255;
                } else if (RoCode.MechanicblockUno.lowList.indexOf(value) > -1) {
                    value = 0;
                } else {
                    throw new Error();
                }
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.MechanicblockUno.sensorTypes.DIGITAL,
                    data: value,
                    time: new Date().getTime(),
                };
        ...
        mechanicblock_uno_digital_pwm: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.MechanicblockUno.sensorTypes.PWM,
                    data: value,
                    time: new Date().getTime(),
                };
                return script.callReturn();
            ...
            func(sprite, script) {
                ...
                if (!script.isStart) {
                    ...
                    if (!RoCode.Utils.isNumber(note)) {
                        note = RoCode.MechanicblockUno.toneTable[note];
                    }
                    ...
                    if (duration === 0) {
                        sq.SET[port] = {
                            type: RoCode.MechanicblockUno.sensorTypes.TONE,
                            data: 0,
                            time: new Date().getTime(),
                        };
                        return script.callReturn();
                    ...
                    if (note != 0) {
                        value = RoCode.MechanicblockUno.toneMap[note][octave];
                    }
        ...
        mechanicblock_uno_set_servo: {
            ...
            func(sprite, script) {
                ...
                sq.SET[port] = {
                    type: RoCode.MechanicblockUno.sensorTypes.SERVO_PIN,
                    data: value,
                    time: new Date().getTime(),
                };
...
module.exports = RoCode.MechanicblockUno;
