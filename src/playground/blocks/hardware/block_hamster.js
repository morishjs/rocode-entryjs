...
RoCode.Hamster.blockMenuBlocks = [
    'hamster_hand_found',
    'hamster_boolean',
    'hamster_value',
...
RoCode.Hamster.getBlocks = function() {
    return {
        hamster_hand_found: {
            ...
            isNotFor: ['hamster'],
            func(sprite, script) {
                const robot = RoCode.Hamster.getRobot();
