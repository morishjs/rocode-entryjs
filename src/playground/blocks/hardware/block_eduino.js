...
RoCode.eduino.setLanguage = function() {
    return {
        ko: {
            template: {
...
RoCode.eduino.getBlocks = function() {
    return {
        eduino_analog_list: {
                        ...
                        textParams: [
                            {
                                ...
                                codeMap: 'RoCode.CodeMap.Arduino.eduino_analog_list[0]',
                                bgColor: RoCodeStatic.colorSet.block.darken.HARDWARE,
                                arrowColor: RoCodeStatic.colorSet.arrow.default.HARDWARE,
                            },
                        ],
        ...
        eduino_get_ultrasonic_value: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.GET[RoCode.eduino.sensorTypes.ULTRASONIC] = {
                    port: [port1, port2],
        ...
        eduino_get_digital: {
            ...
            func(sprite, script) {
                ...
                if (name === 'eduino' || name === 'ArduinoNano') {
                    ...
                    RoCode.hw.sendQueue.GET[RoCode.eduino.sensorTypes.DIGITAL] = {
                        port,
                        time: new Date().getTime(),
                    };
        ...
        eduino_toggle_led: {
            ...
            func(sprite, script) {
                ...
                if (RoCode.eduino.highList.indexOf(value) > -1) {
                    value = 255;
                } else if (RoCode.eduino.lowList.indexOf(value) > -1) {
                    value = 0;
                } else {
                    throw new Error();
                }
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.eduino.sensorTypes.DIGITAL,
                    data: value,
                    time: new Date().getTime(),
                };
        ...
        eduino_digital_pwm: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.eduino.sensorTypes.PWM,
                    data: value,
                    time: new Date().getTime(),
                };
                return script.callReturn();
            ...
            func(sprite, script) {
                ...
                if (!script.isStart) {
                    ...
                    if (!RoCode.Utils.isNumber(note)) {
                        note = RoCode.eduino.toneTable[note];
                    }
                    ...
                    if (duration === 0) {
                        sq.SET[port] = {
                            type: RoCode.eduino.sensorTypes.TONE,
                            data: 0,
                            time: new Date().getTime(),
                        };
                        return script.callReturn();
                    ...
                    if (note != 0) {
                        value = RoCode.eduino.toneMap[note][octave];
                    }
        ...
        eduino_set_servo: {
            ...
            func(sprite, script) {
                ...
                sq.SET[port] = {
                    type: RoCode.eduino.sensorTypes.SERVO_PIN,
                    data: value,
                    time: new Date().getTime(),
                };
