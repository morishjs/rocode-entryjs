...
RoCode.MechanicblockController = {
    id: '39.1',
...
RoCode.MechanicblockController.setLanguage = function() {
    return {
        ko: {
            template: {
...
RoCode.MechanicblockController.blockMenuBlocks = [
...
RoCode.MechanicblockController.getBlocks = function() {
    return {
                        ...
                        textParams: [
                            {
                                ...
                                codeMap: 'RoCode.CodeMap.Arduino.mechanicblock_controller_analog_list[0]',
                                bgColor: RoCodeStatic.colorSet.block.darken.HARDWARE,
                                arrowColor: RoCodeStatic.colorSet.arrow.default.HARDWARE,
                            },
                        ],
        ...
        mechanicblock_controller_get_ultrasonic_value: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.GET[RoCode.MechanicblockController.sensorTypes.ULTRASONIC] = {
                    port: [port1, port2],
        ...
        mechanicblock_controller_get_digital: {
            ...
            func(sprite, script) {
                ...
                if (name === 'MechanicblockController') {
                    ...
                    RoCode.hw.sendQueue.GET[RoCode.MechanicblockController.sensorTypes.DIGITAL] = {
                        port,
                        time: new Date().getTime(),
                    };
        ...
        mechanicblock_controller_toggle_led: {
            ...
            func(sprite, script) {
                ...
                if (RoCode.MechanicblockController.highList.indexOf(value) > -1) {
                    value = 255;
                } else if (RoCode.MechanicblockController.lowList.indexOf(value) > -1) {
                    value = 0;
                } else {
                    throw new Error();
                }
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.MechanicblockController.sensorTypes.DIGITAL,
                    data: value,
                    time: new Date().getTime(),
                };
        ...
        mechanicblock_controller_digital_pwm: {
            ...
            func(sprite, script) {
                ...
                RoCode.hw.sendQueue.SET[port] = {
                    type: RoCode.MechanicblockController.sensorTypes.PWM,
                    data: value,
                    time: new Date().getTime(),
                };
                return script.callReturn();
            ...
            func(sprite, script) {
                ...
                if (!script.isStart) {
                    ...
                    if (!RoCode.Utils.isNumber(note)) {
                        note = RoCode.MechanicblockController.toneTable[note];
                    }
                    ...
                    if (duration === 0) {
                        sq.SET[port] = {
                            type: RoCode.MechanicblockController.sensorTypes.TONE,
                            data: 0,
                            time: new Date().getTime(),
                        };
                        return script.callReturn();
                    ...
                    if (note != 0) {
                        value = RoCode.MechanicblockController.toneMap[note][octave];
                    }
        ...
        mechanicblock_controller_set_servo: {
            ...
            func(sprite, script) {
                ...
                sq.SET[port] = {
                    type: RoCode.MechanicblockController.sensorTypes.SERVO_PIN,
                    data: value,
                    time: new Date().getTime(),
                };
...
module.exports = RoCode.MechanicblockController;
