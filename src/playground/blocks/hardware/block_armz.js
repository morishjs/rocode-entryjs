...
/*
				    var timer = setTimeout(function() {
				        script.timeFlag = 0;
				        RoCode.Armz.removeTimeout(timer);
				    }, timeValue);
				    RoCode.Armz.timeouts.push(timer);
*/
				    return 'Start';
...
RoCode.Armz.setLanguage = function() {
    return {
        en: {
            Blocks: {
                Action: 'Action',
...
RoCode.Armz.getBlocks = function() {
    return {
        armz_run_action: {
                ...
                const data = {
                    ...
                    data: {
                        ...
                        value,
								...
								return RoCode.Armz.postCallReturnDelay({script, data}, 3);
            },
        },
        armz_block_coding_MF: {
            color: RoCodeStatic.colorSet.block.default.HARDWARE,
                ...
                const data = {
                    ...
                    data: {
                        ...
                        value,
								...
								return RoCode.Armz.postCallReturnDelay({script, data}, time);
            },
        },
        armz_block_coding_MB: {
            color: RoCodeStatic.colorSet.block.default.HARDWARE,
        ...
        armz_block_coding_T: {
            ...
            isNotFor: ['armz'],
                ...
                return RoCode.Armz.postCallReturnDelay({script, data}, 2);
            },
        },
				armz_block_coding_LO: {
            color: RoCodeStatic.colorSet.block.default.HARDWARE,
