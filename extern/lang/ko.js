...
Lang.PythonHelper = {
    ...
    repeat_inf_elements:
        'A-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed("Q") 등',
    ...
    boolean_and_elements:
        'A, B-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed("Q") 등',
    ...
    change_string_case_exampleDesc:
        '[시작하기]버튼을 클릭하면 오브젝트가 "Hello RoCode!"를 모두 대문자로 바꾼 "HELLO RoCode!"를 2초간 말한 다음 모두 소문자로 바꾼 "hello RoCode!"를 2초간 말합니다.',
    ask_and_wait_desc:
        "오브젝트가 A 내용을 말풍선으로 묻고, 대답을 입력받습니다. 대답은 실행화면 또는 콘솔창에서 입력할 수 있으며 입력된 값은 'RoCode.answer()'에 저장됩니다. <br>(이 명령어를 사용하면 실행화면에 ‘대답 창’이 생성됩니다.)",
    ...
    get_canvas_input_value_desc:
        'RoCode.input(A) 명령에 의해 실행화면 또는 콘솔에서 입력받은 값입니다.',
