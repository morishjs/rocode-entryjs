...
Lang.Blocks = {
    ...
    "block_hi": "xin chào",
    "RoCode_bot_name": "RoCodebot",
    "hi_RoCode": "Xin chào RoCode!",
    "hi_RoCode_en": "Hello RoCode!",
    "bark_dog": "dog barking",
    "walking_RoCodeBot": "Walking RoCodebot",
...
Lang.Menus = {
    ...
    "deleteAccount_2": "After 30 days, every data that you created in RoCode such as project/lecture/class/post/comment/like/favourite will be deleted and cannot be restored.",
    ...
    "corporateOperator": "The name of the ‘RoCode’ operator",
    ...
    "corporateConsignment": "The name of the ‘RoCode’ operator. And consignment of personal information",
    ...
    "corporateTitle": "Hello. This is RoCodeLabs.<br> We are very grateful to you who are using 'RoCode'. <br>Recently we have agreed to transfer the ownership of RoCode web site, which has been operated for public interest purposes, to the 'Connect Foundation'.<br>Connect Foundation is a non-profit foundation founded by Naver. 'RoCode' will be continuously operated under public interest purpose by 'Connect Foundation'. Therefore, All of “RoCode” users will be guaranteed to use the RoCode exactly as same as before.<br>Since the website provider has changed from the 'RoCodeLabs' to the 'Connect Foundation', there is a transfer of personal information as below. However, this doesn’t mean that your information will be physically moved.<br>",
    ...
    "search_lang": "search",
    "search_title": "title",
    "faq_desc": "Check the answers for the questions you had while using the RoCode.",
    "faq_all": "Total",
    "faq_site": "Site guide",
    "faq_project": "Project",
    ...
    "fword_replace_1": "RoCode is an education platform created to help anyone learn to code.",
    "fword_replace_2": "RoCode is an education platform created to help anyone learn to code.",
    "fword_replace_3": "RoCode is an education platform created to help anyone learn to code.",
    "fword_replace_4": "RoCode is an education platform created to help anyone learn to code.",
    "fword_replace_5": "RoCode is an education platform created to help anyone learn to code.",
    "fword_replace_6": "RoCode is an education platform created to help anyone learn to code.",
    "fword_replace_7": "RoCode is an education platform created to help anyone learn to code.",
    "solve_quiz": "Quiz",
    ...
    "RoCode_rc_desc": "Learn programming concepts in steps with RoCode lectures! Start now!",
    "hw_deadline": "Deadline",
    "rc_course_desc": "Lecture collection created for learning programming concepts level by level",
    "rc_course": "RoCode Recommended Courses",
    "RoCode_rec_course": "RoCode Recommended Courses",
    "RoCode_rec_course_desc": "Anyone can follow along and easily create projects with RoCode Lectures.",
    "guidance": "Guidance",
    "wait": "Wait",
    "hint": "Hint",
    ...
    "main_RoCode_starter": "From basics! RoCode Starter",
    "main_RoCode_booster": "Concepts! RoCode Booster",
    "main_RoCode_master": "Ideas unfold! RoCode Master",
    ...
    "check_out_faq": "Check out RoCode’s FAQ",
    "faq_banner_content": "Do you have any question about RoCode?<br />We give you the answer in FAQ.<br />Find out now!",
    "faq_banner_button": "Go to FAQ",
    "major_updates": "Major updates",
    "check_new_update": "Check out\nRoCode's new updates",
    "major_updates_notification": "RoCode's major updates are announced by notification. ",
    ...
    "offline_download_confirm": "RoCode Offline Editor is available for PC. Would you like to download?",
    "hardware_download_confirm": "RoCode Hardware Program is available for PC. Would you like to download?",
    "copy_text": "Copy text.",
    ...
    "go_boardgame": "RoCode-Bot Board Game",
    "go_cardgame": "RoCode Bot Card game",
    "go_solve": "Learn programming",
    "go_ws": "RoCode Create",
    "go_arts": "RoCode Share",
    ...
    "lesson_share_policy": "I agree to RoCode's Copyright Policies.",
    "project_share_policy": "I agree to RoCode's Copyright Policies.",
    "alert_agree_share": "To share publicly, you must agree to RoCode's copyright policies",
    ...
    "course_share_policy": "I agree to RoCode's Copyright Policies.",
    "issued": "Issued",
    ...
    "lecture_help_6": "choose between block Coding and RoCode Python to organize your learning environment.",
    ...
    "start_me_2": "with <Monthly RoCode>!",
    "monthly_desc_1": "Monthly RoCode is a monthly distributed magazine created ",
    ...
    "monthly_desc_4": "* The Monthly RoCode has ceased publication.",
    "monthly_desc_5": "Download educational materials from the Educational Materials page.",
    "monthly_RoCode": "Monthly RoCode",
    "me_desc_1": "Meet Monthly RoCode magazine distributed monthly!",
    "me_desc_2": "",
    ...
    "recommended_lessons_1": "Follow along, challenge, solve quizzes and learn to program with RoCode!",
    ...
    "offline_main_desc": "Update RoCode Offline Editor",
    ...
    "study_index": "Learn to code with RoCode's coursewares by topic and grade levels",
    "study_for_beginner": "RoCode First Steps for Starters",
    "RoCodebot_desc_3": "Take RoCodebot to school",
    "RoCodebot_desc_4": "by assembling command blocks",
    "move_RoCodebot": "Control RoCodebot",
    "can_change_RoCodebot_1": "Change RoCodebot's color, make it talk",
    "can_change_RoCodebot_2": "using block commands",
    ...
    "solve_mission_desc_2": "Control RoCodebot move through the maze so it can reach its destination while learning the concepts of sequence, repeat, select and comparison.",
    "learning_process_by_grades": "Courseware by grade levels",
    "learning_process_by_grades_sub1": "Learn programming concepts in steps with RoCode lectures! Start now!",
    "e3_to_e4": "Elementary 3-4th grade",
    "e5_to_e6": "Elementary 5-6th grade",
    "m1_to_m3": "7th+ and above",
    "make_using_RoCode": "Create projects with RoCode",
    "make_using_RoCode_desc_1": "Assemble block to create your own program!",
    "make_using_RoCode_desc_2": "Download and follow along the learning materials to create animation, media art, game and other fun programs.",
    ...
    "arithmetic": "산술연산",
    "RoCode_recommended_mission": "RoCode Recommended Mission",
    ...
    "RoCodebot_school": "Go to school",
    "RoCodebot_school_desc_1": "Help RoCodebot to get backpack and go to school",
    "RoCodebot_school_desc_2": "",
    "robot_factory": "Robot Factory",
    "robot_factory_desc_1": "RoCodebot is trapped in a robot factory!",
    "robot_factory_desc_2": "Collect all parts to escape the factory.",
    "electric_car": "Electric Car",
    "electric_car_desc_1": "Help RoCodebot's car move forward ",
    "electric_car_desc_2": "by making sure it has enough fuel.",
    "forest_adventure": "Forest Adventures",
    "forest_adventure_desc_1": "RoCodebot's friends are trapped in the forest!",
    "forest_adventure_desc_2": "Help RoCodebot's friends escape.",
    "town_adventure": "Village Adventures",
    "town_adventure_desc_1": "Help RoCodebot find fuel",
    "town_adventure_desc_2": "in the village.",
    "space_trip": "Space Travels",
    "space_trip_desc_1": "RoCodebot just completed its space exploration.",
    "space_trip_desc_2": "Help RoCodebot return to Earth.",
    ...
    "RoCode_copyright_info": "RoCode copyright guide",
    "pdf": "PDF",
    "helper": "helper",
    "youtube": "vedio",
    "tvcast": "vedio",
    ...
    "RoCode_materials_all": "RoCode Educational Materials",
    "RoCode_material": "Learning RoCode",
    "recommand_grade": "Grade levels",
    "g3_4_grades": "3-4th",
    "g5_6_grades": "5-6th",
    "middle_grades": "7th+",
    "RoCode_go_go": "RoCode Go Go!",
    "RoCode_go_go_desc": "Explore a set of courseware, student activity book and teacher's guide",
    "RoCode_go_go_desc2": "ndevided by grade and difficulty.",
    "stage_beginner": "Basic",
    "stage_middle": "Advanced",
    "stage_high": "Expert",
    "middle_school_short": "7th+",
    "learn_RoCode_programming": "Follow along step by step.",
    "RoCode_programming_desc": "RoCode Programming: Become an RoCode expert!",
    "ebs": "",
    ...
    "python_coding_text": "RoCode Python",
    "python_coding_textbook": "Travel to the text coding world! RoCode Python",
    "python_coding_desc": "Learn the structure and grammar of text coding with RoCode Python!",
    "RoCode_x_hardware_text": "RoCode X Hardware",
    "RoCode_x_hardware": "RoCode Hardware Educational Materials",
    ...
    "materials_teaching_2": "Unplugged Acitivies with RoCode",
    "materials_teaching_3": "Learn by playing in RoCode Coding Missions",
    "materials_teaching_4": "RoCode for Real World Problem Solving",
    ...
    "materials_teaching_9": "Learn to use RoCode LMS effectively ",
    "materials_etc_1": "Getting Started Guide",
    "materials_etc_2": "Contents for Classroom Use",
    "materials_etc_3": "Monthly RoCode",
    "materials_etc_4": "About RoCode",
    "materials_etc_5": "Introducing RoCode",
    "materials_etc_6": "RoCode Block Catalogue",
    "materials_etc_7": "RoCode Python Guide",
    "jr_if_1": "nếu",
    "jr_if_2": "đằng trước",
    ...
    "aboutRoCodeDesc_1": "RoCode is an education platform created to help anyone learn to code.",
    "aboutRoCodeDesc_2": "Students are able to learn to code while playing,",
    "aboutRoCodeDesc_3": "teachers are able to teach effectively.",
    "aboutRoCodeDesc_4": "RoCode is a non-profit service.",
    "aboutRoCodeDesc_5": "",
    "viewProjectTerms": "See usage policy",
    "openSourceTitle": "Promoting open source culture",
    "openSourceDesc_1": "RoCode's source code and ",
    "openSourceDesc_2": "all educational materials",
    "openSourceDesc_3": "are open to public",
    "viewOpenSource": "See open source code",
    "eduPlatformTitle": "RoCode for Classroom Use",
    "eduPlatformDesc_1": "RoCode is developed with teachers ",
    ...
    "researchDesc_1": "RoCode collaborates with researchers to strengthen learning effectiveness",
    "researchDesc_2": "",
    "researchDesc_3": "",
    "viewResearch": "See research materials",
    "atRoCode": "RoCode provides",
    "RoCodeLearnDesc_1": "learn while playing",
    "RoCodeLearnDesc_2": "< Learn > section provides various coursewares and learning materials.",
    "RoCodeLearnDesc_3": "Watch videos, solve problems and learn while playing.",
    "RoCodeLearnDesc_4": "",
    "RoCodeMakeDesc_1": "<Create> section provides block-based coding tool which enables",
    "RoCodeMakeDesc_2": "even first time learners to easily create programs.",
    "RoCodeMakeDesc_3": "And also provides ‘RoCode phython’ mode which is between block-based coding",
    "RoCodeMakeDesc_4": "and text-based coding to help you understand the structure and grammar",
    "RoCodeMakeDesc_5": "of programming languages.",
    "RoCodeShareDesc_1": "<Share> section allows users to share his or her project with others.",
    "RoCodeShareDesc_2": "Explore how the shared projects are created, make improvements,",
    "RoCodeShareDesc_3": "collaborate with friends to make even cooler projects.",
    "RoCodeGroup": "Learning Management Tool",
    "RoCodeGroupTitle": "My Class",
    "RoCodeGroupDesc_1": "<Learning Management Tool> is created to help teachers easily manage students.",
    "RoCodeGroupDesc_2": "Create your own class, assign homework,",
    "RoCodeGroupDesc_3": "share project within the class, and check student progress.",
    "RoCodeGroupDesc_4": "And teacher can lead the class effectively by providing more suitable coursewares",
    "RoCodeGroupDesc_5": "according to the students’ level.",
    ...
    "unpluggedDesc_2": "selection and function by playing RoCode Boardgame and Cardgame.",
    "RoCodeMaze": "RoCodebot Maze Escape",
    "RoCodeAI": "Space Travels",
    "algorithmDesc_1": "Earn a certificate by completing the coding missions.",
    "algorithmDesc_2": "Learn to code while playing.",
    "programmingLangDesc_1": "Coding is made easy with RoCode.",
    ...
    "supportHwDesc_1": "RoCode connects to many physical computing devices to create awesome projects",
    "supportHwDesc_2": "that interacts with the physical world. More devices are continuously added!",
    "RoCodeEduSupport": "RoCode Education Support",
    "eduSupportDesc_1": "RoCode Labs provides educational materials for free.",
    ...
    "moreInfoAboutRoCode_1": "Click on the links below to get RoCode's latest updates.",
    "moreInfoAboutRoCode_2": "Educational materials as well as exciting news are shared.",
    ...
    "RoCode_agree": "Agree to RoCode’s Terms of Use",
    "info_agree": "",
    "next": "Next",
    ...
    "enter_id_pw": "RoCode ID, Password",
    "forgot_password": "Forgot your ID or password?",
    "did_not_join": "Haven’t signed up yet?",
    "go_join": "Go to join",
    "renew_index_text_00": "Learn textbook",
    "renew_index_text_01": "Let's learn RoCode with textbook.",
    "renew_index_text_02": "Through elemRoCode textbook lectures,",
    "renew_index_text_02_2": "learn RoCode!",
    "renew_index_text_03": "Go to",
    "renew_index_text_03_2": "learn textbook",
    "renew_index_text_1": "2019, Meet the changed RoCode",
    ...
    "RoCode_content_one": "Bring your imagination to life with RoCode.",
    "RoCode_content_two": "Create games, animations, media art, and other cool projects!",
    "RoCode_content_three": "Create projects and share with your friends. Enter the exciting world of RoCode!",
    ...
    "make_contents": "In the <Create> section, create your own program with block-based programming language. Create simulation programs to test laws of Physics. Create animation program with your favorite characters. Bring your imagination to life with RoCode. ",
    ...
    "explore_contents": "The <Explore> section, showcases thousands of projects created and shared by the RoCode community. Try out the fun and creative projects, see how they are coded, and improve them. You can also cooperate with your peers to create exciting projects.",
    ...
    "view_RoCode_tools": "Introducing RoCode’s unplugged games for teaching programming.",
    "solve_problem": "Solve Mission",
    "solve_problem_content": "Mini challenges will help you learn the basics of programming.",
    "find_extra_title": "RoCode Bot part finding extravaganza",
    "all_ages": "For all ages",
    "total": "Total",
    "step": "steps",
    "find_extra_contents": "RoCode bot is special robot created one day at the Rutz Robot Toy Factory during a blackout. Help him find his missing parts and escape the factory while learning to code.",
    "software_play_contents": "Watch ‘Let’s Play Software’ , follow along the tutorials and learn to create fun programs.",
    "resources_contents": "Get various RoCode educational materials for free",
    "from": "From",
    ...
    "grades": "Grades",
    "lesson": "Lessons",
    "sw_contents_one": "This guidebook is for elementary students learn physical computing over a 5-lesson course. Students learn to use RoCode and create images and stoires. In the final section, students use Arduino to create a musical keyboard",
    "sw_camp_detail": "Ministry of Science, ICT and Future Planning Software Creation Camp",
    "sw_contents_two": "This textbook allows middle school students to experience RoCode and physical computing over a 5-lesson course. Students learn how to use RoCode, and create a maze game and quiz program. In the final section, students use Arduino and keyboard to steer a car.",
    ...
    "sw_contents_four": "This textbook allows students to learn about computing in a fun and playful way through a variety of unplugged activities such as RoCode Board, and teaches students the basic principles of programming via RoCode Course Mode. Once they have got down the basics, students learn how to create stories, games, artistic works, and applications using RoCode. The textbook allows students to create and present their own software. ",
    ...
    "send": "Send",
    "sensorboard": "RoCode Sensor Board",
    "physical_computing": "Physical Computing",
    "sensorboard_contents": "Using Arduino no longer requires building a circuit using lots of wires. With RoCode Board, you can use LED lights, temperature, sound, light sensors, a slider, and switches by simply mounting it onto an Arduino board. Now anyone can easily create their own unique projects using RoCode Board!",
    "RoCodebot_boardgame": "RoCode-Bot Board Game",
    "unplugged": "Unplugged Activities",
    "unplugged_contents": "Learn the principles of programming through RoCode-bot Board Game. By helping RoCodebot escape the factory, you can learn to think like a computer scientist.",
    "RoCodebot_cardgame": "RoCode Bot Cardgame : Bomb Tempest",
    "RoCodebot_cardgame_contents": "12 different types of bombs appear at the city of RoCode! Dismantle the bombs one at a time and learn the basics of programming. By using the concepts of sequence, repetition and conditionals, save the City and become a hero!",
    "basic_learn": "RoCode Basics",
    "basic_learn_contents": "Learn to program with RoCode’s coursewares",
    ...
    "connected_contents_content": "Discover the variety of content that can be done with the RoCode . If you're new software to learn easily from person to enjoy board games , you can take advantage of the Arduino and physical computing , such as creating a luxurious view of your own creation .",
    "basic_mission": "Basic mission : RoCode bot Maze",
    "basic_mission_content": "A power outage at a toy robot factory magically enabled RoCodebot to come to life. Help RoCodebot escape the factory and find freedom!",
    "application_mission": "Application mission: RoCode bot's Space Odyssey",
    "write_article": "Write",
    ...
    "ebs_software_first": "<Let's Play Software> is a TV series created by Naver, EBS and RoCode Labs. Learn the basic principles of programming. Watch the show, follow along the video tutorials, and learn to code!",
    ...
    "lecture_build_project": "RoCode Project",
    ...
    "play_software_2_content": "<Let's Play Software> is a TV series created by Naver, EBS and RoCode Labs. Learn the basic principles of programming. Watch the show, follow along the video tutorials, and learn to code!",
    ...
    "escape_guide_1": "RoCode Bot suddenly began to think for himself during a power failure at the robot dog factory! ",
    "escape_guide_1_2": " Help RoCode Bot escape the factory and find his freedom!",
    "escape_guide_2": "RoCode Bot is missing too many parts to make it far. Help him find his parts as he makes his way out the factory!",
    ...
    "space_guide_1": "RoCode Bot has finally completed his exploration of distant space. He’s trying to make his way back home to Earth, but his path is being blocked by a bunch of space rocks! Help RoCode Bot make it back to Earth safely!",
    ...
    "cfest_mission": "RoCode Experiential Mission",
    "maze_1_intro": "Hi. I’m RoCode Bot. I’m about to save my injured friends and I need your help. Help me save my friends! First, set up the ‘Move forward one space’ block and press ‘Start’.",
    "maze_1_title": "How to Start",
    "maze_1_content": "How do I move RoCode Bot?",
    ...
    "maze_2_content_2": "How do I move RoCode Bot?",
    ...
    "maze_operation1_1_desc": "Hi, I'm RoCodebot, the robot dog. Give me commands to reach the mission goals. You can learn about the mission when you begin under <span class=\"textShadow\">\'Goals.\'</span>",
    ...
    "maze_command_move_desc": "moves RoCodebot one forward",
    ...
    "make_together_content": "RoCode is created with teachers and students",
    ...
    "essential": "essential",
    "access_term_title": "Hello we are an educational institute RoCode . <br> Thank you for loving your RoCode <br>From April 17, 2016 RoCode Training Institute Website Terms and Conditions <br>  is amended to read as follows:",
    ...
    "footer_phrase": "RoCode is a nonprofit education platform powered by Naver and CONNECT Foundation",
    "footer_use_free": "All materials created by RoCode Labs may be used freely for educational purposes as long as the original source is credited.",
    "footer_description_1": "RoCode is a nonprofit education platform.",
    "footer_description_2": "All materials created by RoCode Labs may be used freely for educational purposes as long as the original source is credited.",
    "nonprofit_platform": "nonprofit educational platform",
    "this_is": "powered by Naver and CONNECT Foundation",
    "privacy": "Privacy policy",
    "RoCode_addr": "16F, 6, Buljeong-ro, Bundang-gu, Seongnam-si, Gyeonggi-do",
    "RoCode_addr_additional_phone": "1522-9182",
    "RoCode_addr_additional_email": "RoCode@connect.or.kr",
    "RoCode_addr_additional_opensource": "Open Source License",
    "phone": "phone",
    "alert_agree_term": "Please agree to RoCode’s Terms of Use",
    ...
    "jr_intro_1": "Hi! My name is Juny! My friend RoCode-Bot is by my right side. Please take me to him! ",
    "jr_intro_2": "RoCode-Bot is by my left! Let's go the left side. ",
    "jr_intro_3": "RoCode-Bot is by my top side. Please help me meet my friend. ",
    "jr_intro_4": "Come on! Let's meet RoCode-Bot! He is by my bottom side. ",
    "jr_intro_5": "Wow! My friend is far away from me. Can you guide me so I can meet RoCode-Bot ",
    "jr_intro_6": "RoCode-Bot is really far away from here! But It's okay. If we use repeat block, we could reach the RoCode-Bot easily.",
    ...
    "jr_intro_12": "Let's meet my friend RoCode-Bot using repeat block.",
    "jr_intro_13": "With this misplaced block, I can't reach my friend. Please change the input number of repeat block.",
    "jr_intro_14": "Please take me to my friend RoCode-Bot using repeat block.",
    "jr_intro_15": "RoCode-Bot is really far away from here! But It's okay. If we use repeat block, we could reach the RoCode-Bot easily.",
    "jr_whats_ur_name": "What is your name to be showned on certification.",
    "jr_down_cert": "Certification",
    "jr_popup_prefix_1": "Hooray! I met RoCode-Bot!",
    "jr_popup_prefix_2": "Nice! I met RoCode-Bot! But we can make it with fewer blocks. How about try again?",
    ...
    "jr_popup_suffix": "Thanks to you! I had fun time with RoCode-Bot. See you around~",
    ...
    "jr_fail_forgot_flower": "I need more flowers for RoCode-Bot. Let's try again.",
    "jr_fail_need_repeat": "Uh? I should use 'repeat block' ! Let's try again with the block~",
    "jr_hint_1": "Hi! My name is Juny! My friend RoCode-Bot is by my right side. Please take me to him!",
    "jr_hint_2": "RoCode-Bot is by my left! Let's go the left side.",
    "jr_hint_3": "RoCode-Bot is by my top side. Please help me meet my friend.",
    "jr_hint_4": "Come on! Let's meet RoCode-Bot! He is by my bottom side.",
    "jr_hint_5": "Wow! My friend is far away from me. Can you guide me so I can meet RoCode-Bot?",
    "jr_hint_6": "Because of the blocks that put together by mistake, I can't reach my friend. Please fix it for me so I can reach my friend RoCode-Bot!",
    ...
    "jr_hint_12": "Let's meet my friend RoCode-Bot using repeat block.",
    "jr_hint_13": "With this misplaced block, I can't reach my friend. Please change the input number of repeat block.",
    "jr_hint_14": "Please take me to my friend RoCode-Bot using repeat block.",
    "jr_hint_15": "RoCode-Bot is really far away from here! But It's okay. If we use repeat block, we could reach the RoCode-Bot easily.",
    ...
    "junior_naver_contents_3": "Please tell Juni to go , so he can meet RoCodebot.",
    "basic_content": "Basic",
    "jr_help": "Help",
    "help": "Help",
    "cparty_robot_intro_1": "Hi, My name is RoCode-bot. I need to to fix myself. Please help me get my parts with 'move forward' block.",
    ...
    "cparty_car_intro_1": "Hi, My name is RoCode-bot. I need battery pack to travel! Can you me get to the battery pack?",
    ...
    "RoCode_first_step": "RoCode First Steps",
    "RoCode_monthly": "Monthly RoCode",
    "play_sw_2": "Let's Play  Software 2",
    "RoCode_programming": "Let's Program!",
    "RoCode_recommanded_course": "RoCode Recommended Courses",
    ...
    "RoCode_info": "About RoCode",
    "actual_size": "Actual Size",
    "zoom_in": "Zoom In",
    "zoom_out": "Zoom Out",
    "cparty_jr_intro_1": "Hi! My name is RoCode-Bot! Please help me get my backpack on my way to school.",
    ...
    "offline_download": "RoCode Download",
    "offline_release": "Download RoCode Offline Editor!",
    "offline_description_1": "Install and use RoCode Offline Editor",
    ...
    "RoCode_offline_download": "Download \nOffline Editor",
    "RoCode_download_detail": "Download\nVeiw Details",
    "offline_desc_1": "Install and use RoCode Offline Editor without internet connection.",
    ...
    "offline_desc_free": "RoCode Offline Editor is free for both individual and corporate use.",
    ...
    "hardware_title": "RoCode Hardware Connector Program Download",
    "hardware_desc": "In order to connect to hardware projects and 'Create Project' online, download and install RoCode Hardware Connector Program.",
    ...
    "lms_banner_RoCode_group": "Create RoCode class ",
    ...
    "generate_code_desc1": "Log in at playRoCode.org",
    ...
    "hide_RoCode": "Hide RoCode",
    "hide_others": "Hide Others",
    "show_all": "Show All",
    "lecture_description": "Lessons are listed by topics and levels. Follow along in step-by-step order.",
    "curriculum_description": "Teacher created RoCode learning space. See example projects and try creating them.",
    ...
    "RoCode_with": "RoCode is Created With Teachers",
    ...
    "exhibit_4th_title": "4th Anniversary of RoCode",
    "exhibit_4th_subtitle": "RoCode Project Contest",
    "exhibit_4th_desc1": "We hold an RoCode Project Contest ",
    "exhibit_4th_desc2": "to celebrate the 4th anniversary of RoCode.",
    "exhibit_4th_desc3": "Show off your great project!",
    "exhibit_4th_button": "View Details",
    "visang_edu_RoCode": "비상교육 엔트리 학습하기",
    "cmass_edu_RoCode": "씨마스 엔트리 학습하기",
    "chunjae_edu_RoCode": "천재교과서 엔트리 학습하기",
    "kumsungemt_edu_RoCode": "금성출판사 엔트리 학습하기",
    "kumsungMid_edu_RoCode": "금성출판사 엔트리 학습하기",
    "gilbutEdu_edu_RoCode": "길벗출판사 엔트리 학습하기",
    "miraenCoding_edu_RoCode": "미래엔 엔트리 학습하기",
    ...
    "project_term_popup_description_1": "Please review the RoCode ",
    ...
    "join_RoCode": "Join RoCode",
    "learned_computing": "Have you learned computing before?",
    "cparty_index_description_1": "My first computing.",
    "cparty_index_description_2": "Learn programming concepts and develop your thinking skills while playing RoCode. ",
    ...
    "maze_content_1": "Hi, I'm RoCodebot. I'm trying to escape from this factory but first, I have to fix myself. Will you help me fetch my parts? Assemble 'Move forward' block and press Start. ",
    ...
    "maze_hints_content_1": "How do I move RoCodebot?",
    ...
    "ai_hints_content_1_3": "How do I move the RoCodebot?",
    ...
    "RoCode_basic_mission": "RoCode basic mission",
    "RoCode_application_mission": "RoCode application mission",
    ...
    "monthly_RoCode_grade": "Elementary 3rd - Middle school 3rd grade",
    "monthly_RoCode_contents": "Learn to program with Monthly RoCode. This monthly digest provides project tutorials, tips and tricks and fun comics. ",
    "monthly_RoCode_etc1": "*The Monthly RoCode project templates are provided in the main page's recommended course",
    "monthly_RoCode_etc2": "* Monthly RoCode is published during school semesters only",
    ...
    "campaign_content_head": "RoCode Project Contest",
    ...
    "code_management_1": "RoCode campaign #1 How to manage code",
    ...
    "shcoolbook_study_1": "Learn the contents of the textbook in RoCode.",
    ...
    "main_learn_1": "If you are new to RoCode",
    "main_learn_2": "Learn about RoCode",
    "main_learn_3": "Watch the video to learn about the various functions of RoCode,",
    "main_learn_4": "create and share your project!",
    "main_learn_5": "Watch the video",
    "hw_desc_wrapper": "Install the Upgraded \nRoCode Hardware Connection Program\nand Offline Editor",
    ...
    "RoCode_user_policy": "RoCode usage policy",
    "RoCode_scholarship_title": "RoCode scholarly data",
    "RoCode_scholarship_content": "RoCode collaborates with researchers to strengthen learning effectiveness. Check out our data.",
    "RoCode_scholarship_content_sub": "*We provide data which is saved in the form of a sequence of processes by users participating in the Online coding party to assist in study and analysis.",
    "RoCode_scholarship_download": "Data download",
    ...
    "learn_programming_RoCode_mission": "Solving missions with RoCodeBot",
    ...
    "search_피지컬": "Physical",
    "search_기타": "ETC",
    "discuss_write_textarea_placeholer": "RoCode community is a space we make together.\nLet's make a fun community with consideration for each other.",
    ...
    "bug_report_content": "Please tell us about errors or good suggestions that you find when you use RoCode.",
    ...
    "advisory_title": "RoCode Advisory Group",
    "advisory_sub_title": "This is an advisory group including teachers and students who make RoCode together.",
...
Lang.Msgs = {
    ...
    "upload_error_content": "Files not complying with the RoCode usage policy are excluded",
    "monthly_intro_0": "Monthly RoCode is an SW training magazine designed to help teachers who are unfamiliar with SW.",
    ...
    "ie_page_desc": "RoCode is available in Internet Explorer 10 or higher or in Chrome browser.<br/>Please update the Windows or install a Chrome browser.<br/>Offline versions are available even though the internet is not connected. Get download now!",
    ...
    "version_update_msg1": "You can use the latest RoCode Offline version(%1).",
    "version_update_msg2": "You can use the latest RoCode Hardware version(%1).",
...
Lang.Workspace = {
    ...
    "download_image_name": "RoCode block",
    "all": "Tất cả",
    "animal": "Animal",
    "arduino_RoCode": "Program for connect to Arduino",
    ...
    "things": "Things",
    "textcoding_tooltip1": "Instructions for 'RoCode Python'<br/>is available. Check out !",
    ...
    "python_guide": "RoCode Python Guide",
    ...
    "fail_contact_msg": "If the problem persists,</br>contact RoCode@connect.or.kr",
    "saving_msg": "Saving",
    ...
    "check_RoCode_file_msg": "Only ENT files are loadable",
    ...
    "select_mode_popup_desc1": "Create projects with<br/>unlimited RoCode features",
...
Lang.Helper = {
    ...
    "get_user_name": "작품을 실행하고 있는 사용자의 이름 값입니다.",
...
Lang.Category = {
    "RoCodebot_friends": "RoCodebot friends",
    "people": "People",
    "animal": "Animal",
...
Lang.TextCoding = {
    ...
    "message_conv_no_RoCode_event_function": "RoCode Event Function can't exist within other functions.",
...
Lang.PythonHelper = {
    ...
    "message_cast_exampleCode": "#\"오브젝트1\"의 파이선 코드\ndef when_start():\n    RoCode.print_for_sec(\"안녕! 넌 몇살이니?\", 2)\n    RoCode.send_signal(\"신호\")\n\n#\"오브젝트2\"의 파이선 코드\ndef when_get_signal(\"신호\"):\n    RoCode.print_for_sec(\"안녕? 난 세 살이야.\", 2)",
    ...
    "message_cast_wait_exampleCode": "#\"오브젝트1\"의 파이선 코드\ndef when_start():\n    RoCode.print_for_sec(\"숨바꼭질하자!\", 2)\n    RoCode.send_signal_wait(\"신호\")\n    RoCode.hide()\n\n#\"오브젝트2\"의 파이선 코드\ndef when_get_signal(\"신호\"):\n    RoCode.print_for_sec(\"그래!\", 2)",
    ...
    "when_scene_start_exampleCode": "#\"장면 1\"의 파이선 코드\ndef when_start():\n    RoCode.print_for_sec(\"다른 곳으로 가볼까?\", 2)\n    RoCode.start_scene(\"장면 2\")\n\n#\"장면 2\"의 파이선 코드\ndef when_start_scene():\n    RoCode.print(\"여기가 어디지?\")",
    ...
    "wait_second_exampleCode": "def when_start():\n    RoCode.add_effect(\"color\", 10)\n    RoCode.wait_for_sec(2)\n    RoCode.add_size(10)",
    ...
    "repeat_inf_elements": "A-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    ...
    "repeat_while_true_elements": "A-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    "repeat_while_true_exampleCode": "def when_start():\n    while not RoCode.is_key_pressed(\"space\"):\n        RoCode.add_rotation(90)",
    ...
    "_if_elements": "A-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    "_if_exampleCode": "def when_click_mouse_on():\n    if (RoCode.value_of_mouse_pointer(\"x\") > 0):\n        RoCode.print_for_sec(\"오른쪽!\", 0.5)",
    ...
    "if_else_elements": "A-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    "if_else_exampleCode": "def when_click_mouse_on():\n    if RoCode.is_touched(\"mouse_pointer\"):\n        RoCode.print(\"닿았다!\")\n    else:\n        RoCode.print(\"안 닿았다!\")",
    ...
    "wait_until_true_elements": "A-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    "wait_until_true_exampleCode": "def when_start():\n    RoCode.print(\"엔터를 눌러봐!\")\n    RoCode.wait_until(RoCode.is_key_pressed(\"enter\"))\n    RoCode.print(\"잘했어!\")",
    ...
    "when_clone_start_exampleCode": "def when_start():\n    for i in range(5):\n        RoCode.make_clone_of(\"self\")\n\ndef when_make_clone():\n    RoCode.set_x(random.randint(-200, 200))",
    ...
    "delete_clone_desc": "RoCode.make_clone_of(A) 명령에 의해 생성된 복제본을 삭제합니다.",
    "delete_clone_exampleCode": "def when_start():\n    for i in range(5):\n        RoCode.make_clone_of(\"자신\")\n\ndef when_make_clone():\n    RoCode.set_x(random.randint(-200, 200))\n\ndef when_click_object_on():\n    RoCode.remove_this_clone()",
    ...
    "direction_relative_exampleCode": "def when_start():\n    RoCode.move_to_direction(50)\n    RoCode.wait_for_sec(0.5)\n    RoCode.add_direction(90)\n    RoCode.wait_for_sec(0.5)\n    RoCode.move_to_direction(50)",
    ...
    "direction_relative_duration_exampleCode": "def when_start():\n    RoCode.add_direction_for_sec(90, 2)\n\ndef when_start():\n    while True:\n        RoCode.move_to_direction(1)",
    ...
    "move_to_angle_exampleCode": "def when_press_key(\"up\"):\n    RoCode.move_to_degree(10, 0)\n\ndef when_press_key(\"down\"):\n    RoCode.move_to_degree(10, 180)",
    ...
    "dialog_time_exampleCode": "def when_start():\n    RoCode.print_for_sec(\"안녕! 나는\", 2)\n    RoCode.print_for_sec(16, 2)\n    RoCode.print_for_sec(\"살이야\", 2)",
    ...
    "change_to_some_shape_exampleCode": "def when_start():\n    RoCode.wait_for_sec(0.3)\n    RoCode.change_shape(\"오브젝트모양\")\n    RoCode.wait_for_sec(0.3)\n    RoCode.change_shape(\"오브젝트모양\")",
    ...
    "change_to_next_shape_exampleCode": "def when_start():\n    RoCode.wait_for_sec(0.3)\n    RoCode.change_shape_to(\"next\")\n    RoCode.wait_for_sec(0.3)\n    RoCode.change_shape_to(\"pre\")",
    ...
    "add_effect_amount_exampleCode": "def when_click_mouse_on():\n    RoCode.add_effect(\"color\", 50)\n    RoCode.wait_for_sec(1)\n    RoCode.add_effect(\"brightness\", -50)\n    RoCode.wait_for_sec(1)\n    RoCode.add_effect(\"transparency\", 50)",
    ...
    "change_effect_amount_exampleCode": "def when_click_mouse_on():\n    RoCode.set_effect(\"color\", 50)\n    RoCode.set_effect(\"brightness\", 50)\n    RoCode.set_effect(\"transparency\", 50)\n\ndef when_click_mouse_off():\n    RoCode.set_effect(\"color\", 0)\n    RoCode.set_effect(\"brightness\", 0)\n    RoCode.set_effect(\"transparency\", 0)",
    ...
    "flip_x_exampleCode": "def when_press_key(\"up\"):\n    RoCode.flip_horizontal()\n\ndef when_press_key(\"right\"):\n    RoCode.flip_vertical()",
    ...
    "change_object_index_exampleCode": "def when_start():\n    RoCode.send_layer_to(\"front\")\n    RoCode.wait_for_sec(2)\n    RoCode.send_layer_to(\"backward\")",
    ...
    "text_read_exampleCode": "def when_start():\n    RoCode.print(RoCode.contents_of_textbox(\"A\"))",
    ...
    "text_append_exampleCode": "def when_start():\n    RoCode.write_text(\"안녕?\")\n    RoCode.wait_for_sec(1)\n    RoCode.append_text(\"엔트리!\")",
    ...
    "text_prepend_exampleCode": "def when_start():\n    RoCode.write_text(\"반가워!\")\n    RoCode.wait_for_sec(1)\n    RoCode.prepend_text(\"엔트리!\")",
    ...
    "is_clicked_exampleCode": "def when_start():\n    while True:\n        if RoCode.is_mouse_clicked():\n            RoCode.print_for_sec(\"반가워!\", 0.5)",
    ...
    "reach_something_exampleCode": "def when_start():\n    while True:\n        RoCode.move_to_direction(10)\n        if RoCode.is_touched(\"edge\"):\n            RoCode.add_rotation(150)",
    ...
    "boolean_and_elements": "A, B-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    "boolean_and_exampleCode": "def when_start():\n    while True:\n        if RoCode.is_key_pressed(\"a\") and RoCode.is_key_pressed(\"s\"):\n            RoCode.add_effect(\"color\", 10)",
    ...
    "boolean_or_elements": "A, B-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    "boolean_or_exampleCode": "def when_start():\n    while True:\n        if RoCode.is_key_pressed(\"a\") or RoCode.is_key_pressed(\"s\"):\n            RoCode.add_effect(\"color\", 10)",
    ...
    "boolean_not_elements": "A-- True 또는 False로 판단할 수 있는 명령어 입력(판단 카테고리의 명령어)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10 등<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\") 등",
    "boolean_not_exampleCode": "def when_start():\n    while True:\n        if not RoCode.is_mouse_clicked():\n            RoCode.add_size(1)",
    ...
    "calc_rand_exampleCode": "def when_start():\n    RoCode.print_for_sec(random.randint(1, 10), 2)\n    RoCode.print_for_sec(random.uniform(0.1, 2), 2)",
    ...
    "coordinate_mouse_exampleCode": "def when_start():\n    while True:\n        RoCode.print(RoCode.value_of_mouse_pointer(\"x\"))",
    ...
    "calc_operation_exampleCode": "def when_start():\n    RoCode.print_for_sec(10 ** 2, 2)\n    RoCode.print_for_sec(math.sqrt(9), 2)\n    RoCode.print_for_sec(math.sin(90), 2)\n    RoCode.print_for_sec(math.fabs(-10), 2)",
    ...
    "get_project_timer_value_exampleCode": "def when_start():\n    RoCode.timer(\"start\")\n    RoCode.wait_for_sec(3)\n    RoCode.timer(\"stop\")\n    RoCode.timer_view(\"hide\")\n    RoCode.print(RoCode.value_of_timer())",
    ...
    "get_date_exampleCode": "def when_start():\n    RoCode.print(RoCode.value_of_current_time(\"year\") + \"년\" + RoCode.value_of_current_time(\"month\") + \"월\")",
    ...
    "distance_something_exampleCode": "def when_start():\n    while True:\n        RoCode.print(RoCode.value_of_distance_to(\"mouse_pointer\"))",
    ...
    "length_of_string_exampleCode": "def when_start():\n    RoCode.print_for_sec(len(\"안녕\"), 2)\n    RoCode.print_for_sec(len(\"엔트리\"), 2)",
    ...
    "change_string_case_exampleCode": "def when_start():\n    RoCode.print_for_sec(\"Hello RoCode!\".upper(), 2)\n    RoCode.print_for_sec(\"Hello RoCode!\".lower(), 2)",
    "change_string_case_exampleDesc": "[시작하기]버튼을 클릭하면 오브젝트가 \"Hello RoCode!\"를 모두 대문자로 바꾼 \"HELLO RoCode!\"를 2초간 말한 다음 모두 소문자로 바꾼 \"hello RoCode!\"를 2초간 말합니다.",
    "ask_and_wait_desc": "오브젝트가 A 내용을 말풍선으로 묻고, 대답을 입력받습니다. 대답은 실행화면 또는 콘솔창에서 입력할 수 있으며 입력된 값은 'RoCode.answer()'에 저장됩니다. <br>(이 명령어를 사용하면 실행화면에 ‘대답 창’이 생성됩니다.)",
    "ask_and_wait_elements": "A-- \"문자열\"",
    "ask_and_wait_exampleCode": "def when_start():\n    RoCode.input(\"이름을 입력해보세요.\")\n    RoCode.print(RoCode.answer() + \" 반가워!\")",
    "ask_and_wait_exampleDesc": "[시작하기]버튼을 클릭하면 오브젝트가 \"이름을 입력해보세요.\"라고 말풍선으로 묻습니다. 이름을 입력하면 \"(입력한 이름) 반가워!\"라 말합니다.",
    "get_canvas_input_value_desc": "RoCode.input(A) 명령에 의해 실행화면 또는 콘솔에서 입력받은 값입니다.",
    ...
    "set_visible_answer_exampleCode": "def when_start():\n    RoCode.answer_view(\"hide\")\n    RoCode.input(\"나이를 입력하세요.\")\n    RoCode.print(RoCode.answer())",
    ...
    "show_variable_exampleCode": "age = 16\n\ndef when_start():\n    RoCode.hide_variable(\"age\")\n    RoCode.wait_for_sec(2)\n    age = 20\n    RoCode.show_variable(\"age\")",
    ...
    "get_weather_data_exampleCode": "def when_start():\n    RoCode.print(Weather.get_lowest_temperature(\"today\", \"Seoul\"))",
    ...
    "get_today_temperature_exampleCode": "def when_start():\n    RoCode.print(Weather.get_today_temperature(\"Seoul\", 00))",
    ...
    "get_today_city_temperature_exampleCode": "def when_start():\n    RoCode.print(Weather.get_today_city_temperature(\"Seoul\", 00))",
...
Lang.SharePolicy = {
    "title": "RoCode Project/Post share Guide"
};
