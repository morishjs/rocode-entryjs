...
Lang.Blocks = {
    ...
    "block_hi": "Hi",
    "entry_bot_name": "RoCodebot",
    "hi_entry": "Hello RoCode!",
    "hi_entry_en": "Hello RoCode!",
    "bark_dog": "dog barking",
    "walking_entryBot": "Walking RoCodebot",
...
Lang.Menus = {
    ...
    "corporateTitle": "Hello. This is RoCodeLabs.<br> We are very grateful to you who are using 'RoCode'. <br>Recently we have agreed to transfer the ownership of RoCode web site, which has been operated for public interest purposes, to the 'Connect Foundation'.<br>Connect Foundation is a non-profit foundation founded by Naver. 'RoCode' will be continuously operated under public interest purpose by 'Connect Foundation'. Therefore, All of “RoCode” users will be guaranteed to use the entry exactly as same as before.<br>Since the website provider has changed from the 'RoCodeLabs' to the 'Connect Foundation', there is a transfer of personal information as below. However, this doesn’t mean that your information will be physically moved.<br>",
    ...
    "entry_rc_desc": "Learn programming concepts in steps with RoCode lectures! Start now!",
    ...
    "entry_rec_course": "RoCode Recommended Courses",
    "entry_rec_course_desc": "Anyone can follow along and easily create projects with RoCode Lectures.",
    "guidance": "Guidance",
    "wait": "Wait",
    "hint": "Hint",
    ...
    "main_entry_starter": "From basics! RoCode Starter",
    "main_entry_booster": "Concepts! RoCode Booster",
    "main_entry_master": "Ideas unfold! RoCode Master",
    ...
    "entrybot_desc_3": "Take RoCodebot to school",
    "entrybot_desc_4": "by assembling command blocks",
    "move_entrybot": "Control RoCodebot",
    "can_change_entrybot_1": "Change RoCodebot's color, make it talk",
    ...
    "make_using_entry": "Create projects with RoCode",
    ...
    "arithmetic": "산술연산",
    "entry_recommended_mission": "RoCode Recommended Mission",
    ...
    "entrybot_school_desc_1": "Help RoCodebot to get backpack and go to school",
    ...
    "entry_copyright_info": "RoCode copyright guide",
    "pdf": "PDF",
    "helper": "helper",
    "youtube": "vedio",
    "tvcast": "vedio",
    ...
    "entry_materials_all": "RoCode Educational Materials",
    "entry_material": "Learning RoCode",
    "recommand_grade": "Grade levels",
    "g3_4_grades": "3-4th",
    "g5_6_grades": "5-6th",
    "middle_grades": "7th+",
    "entry_go_go": "RoCode Go Go!",
    ...
    "entry_programming_desc": "RoCode Programming: Become an RoCode expert!",
    "ebs": "",
    ...
    "entry_x_hardware_text": "RoCode X Hardware",
    "entry_x_hardware": "RoCode Hardware Educational Materials",
    ...
    "entryMaze": "RoCodebot Maze Escape",
    ...
    "entryEduSupport": "RoCode Education Support",
    ...
    "about_entry": "About RoCode",
    "what_entry": "What is RoCode?",
    "create": "Create",
    ...
    "welcome_entry": "Welcome to RoCode",
    "student": "Student",
    "non_menber": "General",
    "teacher": "Teacher",
    ...
    "entry_agree": "Agree to RoCode’s Terms of Use",
    "info_agree": "",
    "next": "Next",
    ...
    "entry_content_one": "Bring your imagination to life with RoCode.",
    "entry_content_two": "Create games, animations, media art, and other cool projects!",
    "entry_content_three": "Create projects and share with your friends. Enter the exciting world of RoCode!",
    ...
    "view_entry_tools": "Introducing RoCode’s unplugged games for teaching programming.",
    ...
    "entrybot_boardgame": "RoCode-Bot Board Game",
    ...
    "entrybot_cardgame": "RoCode Bot Cardgame : Bomb Tempest",
    "entrybot_cardgame_contents": "12 different types of bombs appear at the city of RoCode! Dismantle the bombs one at a time and learn the basics of programming. By using the concepts of sequence, repetition and conditionals, save the City and become a hero!",
    ...
    "essential": "essential",
    "access_term_title": "Hello we are an educational institute RoCode . <br> Thank you for loving your entry <br>From April 17, 2016 RoCode Training Institute Website Terms and Conditions <br>  is amended to read as follows:",
    ...
    "entry_first_step": "RoCode First Steps",
    "entry_monthly": "Monthly RoCode",
    "play_sw_2": "Let's Play  Software 2",
    "entry_programming": "Let's Program!",
    "entry_recommanded_course": "RoCode Recommended Courses",
    ...
    "lms_banner_entry_group": "Create RoCode class ",
    ...
    "entry_with": "RoCode is Created With Teachers",
    ...
    "entry_basic_mission": "RoCode basic mission",
    "entry_application_mission": "RoCode application mission",
    ...
    "monthly_entry_contents": "Learn to program with Monthly RoCode. This monthly digest provides project tutorials, tips and tricks and fun comics. ",
    "monthly_entry_etc1": "*The Monthly RoCode project templates are provided in the main page's recommended course",
    "monthly_entry_etc2": "* Monthly RoCode is published during school semesters only",
    ...
    "entry_user_policy": "RoCode usage policy",
    "entry_scholarship_title": "RoCode scholarly data",
    "entry_scholarship_content": "RoCode collaborates with researchers to strengthen learning effectiveness. Check out our data.",
    ...
    "learn_programming_entry_mission": "Solving missions with RoCodeBot",
...
Lang.Category = {
    "entrybot_friends": "RoCodebot friends",
    "people": "People",
    "animal": "Animal",
...
Lang.TextCoding = {
    ...
    "message_conv_no_entry_event_function": "RoCode Event Function can't exist within other functions.",
...
Lang.PythonHelper = {
    ...
    "change_string_case_exampleDesc": "[시작하기]버튼을 클릭하면 오브젝트가 \"Hello RoCode!\"를 모두 대문자로 바꾼 \"HELLO RoCode!\"를 2초간 말한 다음 모두 소문자로 바꾼 \"hello entry!\"를 2초간 말합니다.",
