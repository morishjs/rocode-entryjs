...
Lang.Blocks = {
    ...
    "ARDUINO_download_source": "• RoCodeのArduinoコード",
...
Lang.Menus = {
    ...
    "RoCode_rc_desc": "プログラミングの原理を学習レベルに合わせて学べるエントリー講義集! 今すぐ始めてみましょう!<br>お手本にしながら挑戦してソフトウェアを制作すれば、難しく感じられたプログラミングの原理も楽しく簡単に身につきます!",
    "hw_deadline": "締切日",
    "rc_course_desc": "プログラミングの原理を学習レベルに合わせて学べるよう構成されたエントリー講義集です。",
    "rc_course": "オススメ講義集",
    "RoCode_rec_course": "エントリーオススメ講義集",
    "RoCode_rec_course_desc": "誰でも簡単に、真似をしながら楽しくバラエティ豊かなソフトウェアを制作できるエントリー講義を紹介します。",
    "guidance": "案内",
    "wait": "ストップ！",
    "hint": "ヒント",
    ...
    "main_RoCode_starter": "基礎から! エントリースターター",
    "main_RoCode_booster": "概念固め! エントリーブースター",
    "main_RoCode_master": "思考を広げる! エントリーマスター",
    ...
    "RoCodebot_desc_3": "案内に従ってブロックコマンドを並べて",
    "RoCodebot_desc_4": "エントリーボットを学校に連れていってください。",
    "move_RoCodebot": "エントリーボットを動かす",
    "can_change_RoCodebot_1": "ブロックコマンドでエントリーボットの色を変えたり",
    "can_change_RoCodebot_2": "おしゃべりさせることもできます。",
    ...
    "e5_to_e6": "小学校5-6年生",
    "m1_to_m3": "中学生以上",
    "make_using_RoCode": "エントリーで作る",
    "make_using_RoCode_desc_1": "ブロックを積み重ねて様々なソフトウェアを制作してみてください!",
    "make_using_RoCode_desc_2": "提供される教材をダウンロードして少しずつ進めると、アニメーション、メディアアート、ゲームなどのバラエティ豊かな作品を制作できます。",
    ...
    "arithmetic": "算術演算",
    "RoCode_recommended_mission": "エントリーのオススメミッション",
    ...
    "RoCodebot_school": "エントリーボットの通学路",
    "RoCodebot_school_desc_1": "エントリーボットがカバンを持って学校に",
    "RoCodebot_school_desc_2": "到着できるように手伝ってください!",
    ...
    "RoCode_copyright_info": "エントリー著作権ガイド表示",
    "pdf": "PDF",
    "helper": "ヘルプ",
    "youtube": "映像",
    "tvcast": "映像",
    ...
    "RoCode_materials_all": "エントリーの教育資料集",
    "RoCode_material": "エントリーの教育資料",
    "recommand_grade": "推奨学年",
    "g3_4_grades": "3-4年生",
    "g5_6_grades": "5-6年生",
    "middle_grades": "中学生以上",
    "RoCode_go_go": "エントリーゴーゴー!",
    "RoCode_go_go_desc": "学年別・難易度別に用意された教材をぜひご活用ください！",
    "RoCode_go_go_desc2": "各課程別に教育課程・学習指導・教師用指導資料の3点セットを提供しております。",
    "stage_beginner": "初級",
    "stage_middle": "中級",
    "stage_high": "上級",
    "middle_school_short": "中等",
    "learn_RoCode_programming": "お手本にして学ぶエントリープログラミング",
    "RoCode_programming_desc": "少しずつ進めれば、いつの間にかあなたもエントリーの達人に!",
    "ebs": "EBS",
    ...
    "RoCode_x_hardware_text": "エントリーXハードウェア教育資料",
    "RoCode_x_hardware": "エントリーXハードウェア教育資料集",
    "e_sensor": "Eセンサーボード",
    ...
    "aboutRoCodeDesc_1": "エントリーは、誰でも無料で使えるプログラミング教育プラットフォームです。",
    "aboutRoCodeDesc_2": "生徒はプログラミングを簡単に楽しく学習し、",
    "aboutRoCodeDesc_3": "先生は効果的に生徒を教えることができます。",
    "aboutRoCodeDesc_4": "エントリーは公共財のように",
    "aboutRoCodeDesc_5": "非営利で運営されています。",
    ...
    "atRoCode": "エントリーでは",
    "RoCodeLearnDesc_1": "楽しく学べる学習スペース",
    "RoCodeLearnDesc_2": "< 学習する >には、コンピューターを活用して論理的に問題を解決できるバラエティ豊かな学習",
    "RoCodeLearnDesc_3": "コンテンツが用意されています。ゲーム感覚で楽しく与えられたミッションをプログラミングで",
    "RoCodeLearnDesc_4": "解決することができ、役立つ動画を通してソフトウェアの原理を学ぶことができます。",
    "RoCodeMakeDesc_1": "< 作る >では、米MITで開発したScratchのようなブロック型プログラミング言語を",
    "RoCodeMakeDesc_2": "使用し、初めてプログラミングに触れる人でも簡単に自分だけの創作物を制作できます。",
    "RoCodeMakeDesc_3": "さらに、ブロックコーディングとテキストコーディングの橋渡し役をする「エントリーパイソン」モードでは、",
    "RoCodeMakeDesc_4": "テキスト言語の構造と文法を自然に身につけることができます。",
    "RoCodeMakeDesc_5": " ",
    "RoCodeShareDesc_1": "< 共有する >では、エントリーを通して制作した作品を他の人と共有することができます。",
    "RoCodeShareDesc_2": "また、共有された作品がどのように構成されているのかを調べることができ、これを発展させて自分だけの作品を制作",
    "RoCodeShareDesc_3": "できます。共同創作もできますので、友達と力を合わせてもっと良い作品を制作することもできます。",
    "RoCodeGroup": "クラス機能",
    "RoCodeGroupTitle": "クラス学習スペース",
    "RoCodeGroupDesc_1": "< クラス機能 >は、教師がクラスごとに学生たちを管理できる機能です。クラスの学生同士で学習して",
    "RoCodeGroupDesc_2": "作品を共有することができ、課題を作り学生たちの成果物を確認できます。",
    "RoCodeGroupDesc_3": "また、教師は、講義機能を活用して学生たちのレベルにあった学習環境を",
    "RoCodeGroupDesc_4": "カスタマイズして提供することで、効率的かつ楽に授業を進めることができます・",
    "RoCodeGroupDesc_5": " ",
    ...
    "RoCodeMaze": "エントリーボット迷路脱出",
    "RoCodeAI": "エントリーボット宇宙旅行",
    ...
    "moreInfoAboutRoCode_1": "エントリーのニュースをもっと確認したいなら、次のリンクにアクセスしてください。",
    "moreInfoAboutRoCode_2": "教育資料のほかにもバラエティ豊かなSW教育関連情報を共有しています。",
    ...
    "renew_index_text_1": "2019年、RoCodeが変わります。",
    ...
    "RoCode_content_one": "想像していたことをブロックで遊び感覚で1つずつ積み上げてみてください。",
    "RoCode_content_two": "ゲーム、アニメーション、メディアアートといった素晴らしい作品を完成できます!",
    "RoCode_content_three": "楽しいゲームで学び、自分だけの素晴らしい作品を制作して友達と共有できる素晴らしいエントリーの世界に皆さんをご招待します!",
    ...
    "sandbug": "シェリル・サンドバーグ",
    "view_RoCode_tools": "エントリーと一緒にできる教具を確認できます。",
    ...
    "RoCodebot_boardgame": "エントリーボットボードゲーム",
    "unplugged": "アンプラグド活動",
    ...
    "RoCodebot_cardgame": "エントリーボットカードゲーム : 爆弾大騒動",
    "RoCodebot_cardgame_contents": "エントリーシティに突如現れた12種類の爆弾! 全ての爆弾を無事に解体することはできるでしょうか? 爆弾を1つずつ解体し、エントリーブロックと一緒にソフトウェアの原理を学んでみましょう!  順次、反復、条件を通して爆弾を1つずつ解体していけば、エントリーシティを救ったヒーローになれますよ!",
    ...
    "this_is": "です。",
    "privacy": "プライバシーポリシー",
    "RoCode_addr": "京畿道 城南市 盆唐區 佛亭路 6 NAVER グリーンファクトリー16階",
    "RoCode_addr_additional_phone": "02-6202-9783",
    ...
    "RoCode_first_step": "エントリーの第一歩",
    "RoCode_monthly": "月刊エントリー",
    "play_sw_2": "EBS ソフトウェア、遊ぼう2",
    "RoCode_programming": "実践、プログラミング!",
    "RoCode_recommanded_course": "エントリーのオススメコース",
    ...
    "RoCode_offline_download": "エントリーオフライン\nダウンロード",
    "RoCode_download_detail": "ダウンロード\nへ移動",
    ...
    "lms_banner_RoCode_group": "エントリークラスを作成する",
    ...
    "visang_edu_RoCode": "ビサン教育　エントリーを学習する",
    "cmass_edu_RoCode": "CMAS　エントリーを学習する",
    "chunjae_edu_RoCode": "天才教科書　エントリーを学習する",
    "kumsungemt_edu_RoCode": "ギムソン出版社 エントリーを学習する",
    "kumsungMid_edu_RoCode": "ギムソン出版社 エントリーを学習する",
    "gilbutEdu_edu_RoCode": "ギルバート出版社 エントリーを学習する",
    "miraenCoding_edu_RoCode": "ミライエン エントリーを学習する",
    ...
    "RoCode_basic_mission": "エントリー基本ミッション",
    "RoCode_application_mission": "エントリー応用ミッション",
    ...
    "monthly_RoCode_grade": "小学校3学年 ~ 中学校3学年",
    "monthly_RoCode_contents": "毎月発刊される月刊エントリーと共にソフトウェア教育を始めてみましょう! 少しずつ進めて行けば簡単に身に着けられるよう、ライトに構成されています。基本、応用コンテンツに加え、さらにその先まで! 毎月アップデートされる8つのコンテンツと教材をお楽しみください~",
    "monthly_RoCode_etc1": "*メインページの月刊エントリーオススメコースを活用すれば、もっと簡単に授業を進めることができます。",
    "monthly_RoCode_etc2": "*月刊エントリーは学期中にのみ発刊されます。",
    ...
    "code_management_1": "RoCodeキャンペーン#1 コードを上手に管理しよう",
    ...
    "RoCode_user_policy": "エントリー利用ポリシー",
    "RoCode_scholarship_title": "エントリー学術資料",
    "RoCode_scholarship_content": "エントリーは大学/学会などと共に多様な研究を行い、専門性を強化し続けています。エントリーで提供している研究用資料を確認してみてください。",
    "RoCode_scholarship_content_sub": "*エントリーで提供するデータは、研究及び分析に活用されるようオンラインコーディングパーティーに参加したユーザーたちがミッションを解決する一連の過程をログ形式で保存したデータです。",
    "RoCode_scholarship_download": "資料ダウンロード",
    ...
    "learn_programming_RoCode_mission": "「エントリーボット」と一緒にミッションを解決する",
    ...
    "search_피지컬": "フィジカル",
    "search_기타": "その他",
    "discuss_write_textarea_placeholer": "RoCodeコミュニティは、みんなでいっしょにきずいていく空間です。\n互いに気づかう言葉で楽しいコミュニティにしましょう！",
    ...
    "discuss_write_textarea_placeholer_free": "このページはRoCodeストーリー掲示板です。\nお互い思いやる言葉を使って楽しいコミュニティにしましょう。",
...
Lang.Workspace = {
    ...
    "download_image_name": "RoCode_ブロック",
    "all": "すべて",
    "animal": "動物",
    ...
    "fail_contact_msg": "続けて問題が発生する場合は</br>RoCode@connect.or.krにお問い合わせください。",
    "saving_msg": "保存中です。",
    ...
    "check_RoCode_file_msg": "ENTファイルのみ読み込むことができます。",
...
Lang.TextCoding = {
    ...
    "message_conv_no_RoCode_event_function": "エントリーイベント関数は他の関数の中に存在できません。",
...
Lang.PythonHelper = {
    ...
    "message_cast_exampleCode": "#\"オブジェクト1\"のパイソンコード\ndef when_start():\n    RoCode.print_for_sec(\"やあ! 君は何歳なの?\", 2)\n    RoCode.send_signal(\"信号\")\n\n#\"オブジェクト2\"のパイソンコード\ndef when_get_signal(\"信号\"):\n    RoCode.print_for_sec(\"やあ。僕は3歳だよ。\", 2)",
    ...
    "message_cast_wait_exampleCode": "#\"オブジェクト1\"のパイソンコード\ndef when_start():\n    RoCode.print_for_sec(\"かくれんぼしようよ!\", 2)\n    RoCode.send_signal_wait(\"信号\")\n    RoCode.hide()\n\n#\"オブジェクト2\"のパイソンコード\ndef when_get_signal(\"信号\"):\n    RoCode.print_for_sec(\"いいよ!\", 2)",
    ...
    "when_scene_start_exampleCode": "#\"シーン 1\"のパイソンコード\ndef when_start():\n    RoCode.print_for_sec(\"他の場所に行こうか?\", 2)\n    RoCode.start_scene(\"シーン 2\")\n\n#\"シーン 2\"のパイソンコード\ndef when_start_scene():\n    RoCode.print(\"ここはどこだろう?\")",
    ...
    "repeat_inf_elements": "A-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    ...
    "repeat_while_true_elements": "A-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    ...
    "_if_elements": "A-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    "_if_exampleCode": "def when_click_mouse_on():\n    if (RoCode.value_of_mouse_pointer(\"x\") > 0):\n        RoCode.print_for_sec(\"右側!\", 0.5)",
    ...
    "if_else_elements": "A-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    ...
    "wait_until_true_elements": "A-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    "wait_until_true_exampleCode": "def when_start():\n    RoCode.print(\"エンターを押してみて!\")\n    RoCode.wait_until(RoCode.is_key_pressed(\"enter\"))\n    RoCode.print(\"うまいね!\")",
    ...
    "delete_clone_desc": "RoCode.make_clone_of(A) コマンドにより作成されたコピーを削除します。",
    "delete_clone_exampleCode": "def when_start():\n    for i in range(5):\n        RoCode.make_clone_of(\"自分\")\n\ndef when_make_clone():\n    RoCode.set_x(random.randint(-200, 200))\n\ndef when_click_object_on():\n    RoCode.remove_this_clone()",
    ...
    "text_append_exampleCode": "def when_start():\n    RoCode.write_text(\"やあ!\")\n    RoCode.wait_for_sec(1)\n    RoCode.append_text(\"エントリー!\")",
    ...
    "text_prepend_exampleCode": "def when_start():\n    RoCode.write_text(\"嬉しいな!\")\n    RoCode.wait_for_sec(1)\n    RoCode.prepend_text(\"エントリー!\")",
    ...
    "boolean_and_elements": "A, B-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    ...
    "boolean_or_elements": "A, B-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    ...
    "boolean_not_elements": "A-- TrueまたはFalseと判断できるコマンド入力(判断カテゴリーのコマンド)<br>① True, False<br>② 10 == 10 , 10 > 10 , 10 <= 10など<br>③ RoCode.is_mouse_clicked(), RoCode.is_key_pressed(\"Q\")など",
    ...
    "coordinate_object_exampleCode": "def when_start():\n    while True:\n        RoCode.add_x(1)\n        RoCode.print(RoCode.value_of_object(\"オブジェクト\", \"x\"))\n",
    ...
    "get_date_exampleCode": "def when_start():\n    RoCode.print(RoCode.value_of_current_time(\"year\") + \"年\" + RoCode.value_of_current_time(\"month\") + \"月\")",
    ...
    "get_sound_duration_exampleCode": "def when_start():\n    RoCode.print(RoCode.value_of_sound_length_of(\"サウンド\"))",
    ...
    "length_of_string_exampleCode": "def when_start():\n    RoCode.print_for_sec(len(\"やあ\"), 2)\n    RoCode.print_for_sec(len(\"エントリー\"), 2)",
    ...
    "change_string_case_exampleDesc": "[スタート]ボタンをクリックすると、オブジェクトが\"Hello RoCode!\"をすべて大文字に置き換えた\"HELLO RoCode!\"を2秒間話した後、すべて小文字に置き換えた\"hello RoCode!\"を2秒間話します。",
    "ask_and_wait_desc": "オブジェクトがAの内容を吹き出しで尋ね、回答の入力を受けます。回答は実行画面またはコンソールウィンドウで入力でき、入力された値は'RoCode.answer()'に保存されます。<br>(このコマンドを使うと実行画面に「回答ウィンドウ」が作成されます。)",
    "ask_and_wait_elements": "A-- \"文字列\"",
    "ask_and_wait_exampleCode": "def when_start():\n    RoCode.input(\"名前を入力してみてください。\")\n    RoCode.print(RoCode.answer() + \" 嬉しいな!\")",
    "ask_and_wait_exampleDesc": "[スタート]ボタンをクリックすると、オブジェクトが\"名前を入力してみてください。\"と吹き出しで尋ねます。名前を入力すると\"(入力した名前) 嬉しいな!\"と話します。",
    "get_canvas_input_value_desc": "RoCode.input(A) コマンドにより実行画面またはコンソールで入力された値です。",
